...
> 
> **mac os를 사용하시는 경우 초기 실행시 앱 내부 폴더에 StreamingAssets/Parameters.json 파일이 없어 에러가 발생할 수 있습니다. 직접 앱 내부로 들어가서 직접 StreamingAssets 폴더를 만들어주고 Parameters.json 파일을 만들어준 다음 값을 입력해줘야합니다. 값은 다음의 [환경 관련 ](https://github.com/reinforcement-learning-kr/rlkorea_drone_challenge/blob/master/docs/rl_village_info.md) 내용을 참고해주세요**
